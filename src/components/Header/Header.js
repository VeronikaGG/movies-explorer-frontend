    ...
    >
      ...
      <div className='header__right'>
        ...
        <div className={`header__container ${isBurgerOpen ? 'header__burger-opened' : ''}`}>
          <Link
            to='/'
            className={`header__burgerlink ${location.pathname === '/' ? 'header__burgerlink-here' : ''}`}
            onClick={onClose}
          >
            Главная
          </Link>
          <Link
            to='/movies'
            className={`header__burgerlink ${location.pathname === '/movies' ? 'header__burgerlink-here' : ''}`}
            onClick={onClose}
          >
            Фильмы
          </Link>
          <Link
            to='/saved-movies'
            className={`header__burgerlink ${location.pathname === '/saved-movies' ? 'header__burgerlink-here' : ''}`}
            onClick={onClose}
          >
            Сохранённые фильмы
          </Link>
