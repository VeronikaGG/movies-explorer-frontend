...
function Login(props) {
  const { formValue, error, handleChange, resetValidation, isValid } = useFormValidation();
  ...
  return (
    <section className='login'>
      <form name='login__form' className='login__form' onSubmit={handleSubmit}>
        <div className='login__inputs'>
          <Link className='login__logo' to='/' onClick={handleResetAll}>
            <img className='login__logo' src={logo} alt='Movies Explorer' />
          </Link>
          <h2 className='login__title'>Рады видеть!</h2>
          <label htmlFor='email-field' className='login__lable'>
            E-mail
          </label>
          <input
            type='email'
          ...
          <label htmlFor='password-field' className='login__lable'>
            Пароль
          </label>
          <input
            type='password'
      ...
      <div className='login__bottom'>
        ...
        <Link to='/signup' className='login__text login__link' onClick={handleResetAll}>
          Регистрация
        </Link>
      </div>
    </section>
