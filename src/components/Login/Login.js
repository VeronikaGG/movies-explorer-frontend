    ...
    <section className='login'>
      <form name='login__form' className='login__form'>
        <div className='login__inputs'>
          ...
          <label for='email-field' className='login__lable'>
            E-mail
          </label>
          <input
            type='email'
          ...
          <label for='password-field' className='login__lable'>
            Пароль
          </label>
          <input
            type='text'
        ...
        <button type='submit' className='login__submit' name='submit' defaultValue='Войти'>
          Войти
        </button>
      </form>
