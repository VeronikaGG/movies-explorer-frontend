    ...
    <section className='register'>
      <form name='register__form' className='register__form'>
        <div className='register__inputs'>
          ...
          <label for='email-field' className='register__lable'>
            E-mail
          </label>
          <input
            type='email'
          ...
          <label for='password-field' className='register__lable'>
            Пароль
          </label>
          <input
            type='text'
        ...
        <button type='submit' className='register__submit' name='submit' defaultValue='Зарегистрироваться'>
          Зарегистрироваться
        </button>
      </form>
