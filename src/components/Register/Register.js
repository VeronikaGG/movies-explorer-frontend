...
function Register(props) {
  const { formValue, error, resetValidation, handleChange, isValid } = useFormValidation();
  ...
  return (
    <section className='register'>
      <form name='register__form' className='register__form' onSubmit={handleSubmit}>
        <div className='register__inputs'>
          <Link className='register__logo' to='/' onClick={handleResetAll}>
            <img className='register__logo' src={logo} alt='Movies Explorer' />
          </Link>
          <h2 className='register__title'>Добро пожаловать!</h2>
          <label htmlFor='name-field' className='register__lable'>
            Имя
          </label>
          <input
            type='text'
          ...
          <label htmlFor='email-field' className='register__lable'>
            E-mail
          </label>
          <input
            type='email'
          ...
          <label htmlFor='password-field' className='register__lable'>
            Пароль
          </label>
          <input
            type='password'
      ...
      <div className='register__bottom'>
        ...
        <Link to='/signin' className='register__text register__link' onClick={handleResetAll}>
          Войти
        </Link>
      </div>
    </section>
