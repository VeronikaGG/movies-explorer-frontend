...
function Profile(props) {
  ...
  const { formValue, error, handleChange, setData } = useFormValidation();
      ...
      >
        <div className="profile__inputs">
          ...
          <div className="profile__input">
            ...
            <input
              ...
              disabled={props.isEditing ? false : true}
            ></input>
            <span className="email-field-error profile__span">
              {error.email}
            </span>
          </div>
        </div>
        ...
        <button
          ...
          className={`profile__submit ${
            props.isEditing ? "" : "profile__hidden"
          } ${props.buttonDisabled ? "profile__disabled" : " "}`}
          name="submit"
